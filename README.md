...
* **핵심 로직:** 브랜드 신뢰도를 정량화하기 위해 전문가 리뷰 비율, 엘리트 유저 활동도, 리뷰의 질(Text Length & Sentiment)을 결합한 고유 지표 설계
...
* **전략 수립:** 분석 결과를 실제 점주가 이해하기 쉬운 비즈니스 언어로 번역하여 솔루션 도출
* **리포팅 툴:** **Tilda**를 사용하여 웹 기반의 인터랙티브 리포트 제작 (가상의 컨설팅 회사 '한입거리' 컨셉)
* **가독성 최적화:** 복잡한 ML 모델 결과를 시각화하여 비전공자도 데이터 기반 의사결정을 내릴 수 있도록 보고서 구조 설계

### 💻 핵심 분석 및 모델링 코드
본 프로젝트에서 제가 담당한 지표 설계, 검증 및 모델링의 전체 과정입니다.
...
* [🤖 3. 폐업 예측 분류 머신러닝 모델링](./분류모델_신뢰점수.ipynb)
  - CatBoost 모델을 활용한 폐업 매장 예측 및 신뢰지수의 기여도 분석

---
🔗 **[최종 비즈니스 리포트 보러가기 (Tilda)](여기에_틸다_링크_넣으세요)**
---
